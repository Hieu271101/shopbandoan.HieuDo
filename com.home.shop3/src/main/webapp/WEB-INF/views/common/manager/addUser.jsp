		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="tile">
					...
					<h3 class="tile-title">Người dùng</h3>
					<div class="tile-body">
                ...
                <div class="col-sm-2">
                  <a class="btn btn-add btn-sm" data-toggle="modal" data-target="#exampleModalCenter"><b><i
						...
						<sf:form modelAttribute="newUser" class="row" method="post"
							action="/admin/user/management"  enctype="multipart/form-data">
		<sf:hidden path="password"/>
		<sf:hidden path="userName"/>
							<sf:hidden path="id" class="form-control" />
							<div class="form-group col-md-4">
								<label class="control-label">Họ và tên</label>
								<sf:input path="name" disabled="true" class="form-control" type="text" />
							</div>
							<div class="form-group col-md-4">
								<label class="control-label">Địa chỉ email</label>
								<sf:input path="userName" disabled="true" class="form-control" type="text" />
							</div>
		
							<%--  <div class="form-group col-md-4">
								<label class="control-label">Ngày sinh</label>
								<sf:input path="dob" id="dob" disabled="true" class="form-control" type="date" />
							</div>  --%>
							<div class="form-group  col-md-4">
								<label class="control-label">Số điện thoại</label>
								<sf:input path="phone" disabled="true" class="form-control" type="number" />
							</div>
							<div class="form-group col-md-4">
								<label class="control-label">Địa chỉ thường trú</label>
								<sf:input path="shippingAddress" disabled="true" class="form-control" type="text" />
							</div>


							<div class="form-group col-md-4">
								<label class="control-label">Giới tính</label>
									<sf:input path="gender" disabled="true" class="form-control" type="text" />
								<%-- <sf:select disabled="true" path="gender" class="form-control"
									id="exampleSelect2">
