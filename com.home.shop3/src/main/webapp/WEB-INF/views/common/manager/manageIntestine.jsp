...
<body onload="time()" class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="${base }/admin/intestine"><i class='app-menu__icon bx bx-run'></i><span
              ...
              <div class="tile-body">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                      ...
                      <td>${item.descriptionCondition }</td>
                      <td><span class="badge bg-danger">Thôi việc</span></td>
